...
define config.name = _("En Nombre de la Humanidad Seleccion")
...
define build.name = "EnNombredelaHumanidadSeleccion"
...
define config.save_directory = "EnNombredelaHumanidadSeleccion-1681011611"
