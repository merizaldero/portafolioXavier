% include('xpd_health/encabezado.tpl', titulo="Datos de DosisInsulina", usuario = usuario, estilo = "")
% if lvl != "" :
...
<div class="row">
    <label class="col form-label" for="unidades_aplicadas">
    unidades_aplicadas*:
    </label>

<span class="col">
        <input class="form-control" type="number" name="unidades_aplicadas" value="{{objeto['unidades_aplicadas']}}" maxlength="0">
    </span>
...
<div class="row">
    ...
    <span class="col">
        <input class="form-control" type="text" name="observacion" value="{{des_convertir_acentos(objeto['observacion'])}}" maxlength="128">
    </span>
