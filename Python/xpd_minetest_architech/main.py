...
@app.route('/textures/<filepath:path>')
def server_texture(filepath):
    return static_file(filepath , root = dirname(abspath(__file__)) + '/textures' )
...
def home():
    ...
    if usuario is None:
        ...
        redirect('/xpd_minearch/edificios')

xpd_usr.rutearModulo(app,'/xpd_usr')
xpd_minearch.rutearModulo(app,'/xpd_minearch')
