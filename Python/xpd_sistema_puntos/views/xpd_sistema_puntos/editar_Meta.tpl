% include('xpd_sistema_puntos/encabezado.tpl', titulo="Datos de Meta", usuario = usuario, estilo = "")
% if lvl != "" :
...
<div class="row">
    <label class="col form-label" for="fecha_creacion">
    fecha_creacion*:
    </label>

    <span class="col">
        <input class="form-control" type="datetime-local" name="fecha_creacion" value="{{fecha_iso_to_js(objeto['fecha_creacion'])}}" >
    </span>

</div>

<div class="row">
    <label class="col form-label" for="fecha_vencimiento">
    fecha_vencimiento*:
    </label>

    <span class="col">
        <input class="form-control" type="datetime-local" name="fecha_vencimiento" value="{{fecha_iso_to_js(objeto['fecha_vencimiento'])}}" >
    </span>
