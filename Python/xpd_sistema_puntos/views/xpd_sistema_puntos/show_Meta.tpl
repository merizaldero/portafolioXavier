% include('xpd_sistema_puntos/encabezado.tpl', titulo="Meta", usuario = usuario, estilo = "")
...
<div class="row">
    ...
    <div class="d-flex flex-row justify-content-around border-top border-bottom pt-1 pb-1">
        ...
        <a class="btn btn-primary" href="/xpd_sistema_puntos/metas/{{objeto['id']}}/editar">
            Editar
        </a>
        <a class="btn btn-secondary" href="/xpd_sistema_puntos/metas/{{objeto['id']}}/eliminar" onclick="return confirm('Desea proceder con eliminación?');">
            Eliminar
        </a>
    </div>
