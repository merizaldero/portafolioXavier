...
Usuarios.setMetamodelo({
    ...
    "propiedades":[
        ...
        { "nombre":"username", "nombreCampo":"USERNAME", "tipo":orm.XPDSTRING, "tamano":32, },
        { "nombre":"pwd", "nombreCampo":"PWD", "tipo":orm.XPDSTRING, "tamano":128, },
        { "nombre":"email", "nombreCampo":"EMAIL", "tipo":orm.XPDSTRING, "tamano":32, },
        { "nombre":"sessiontoken", "nombreCampo":"SESSIONTOKEN", "tipo":orm.XPDSTRING, "tamano":36, },
    ...
    "namedQueries":[
        ...
        { "nombre":"findByUsername", "whereClause":["username",] },
        { "nombre":"findBySessiontoken", "whereClause":["sessiontoken",] },
        { "nombre":"findByEmail", "whereClause":["email",] }
        ]
    })
...
Roles.setMetamodelo({
    ...
    "propiedades":[
        { "nombre":"id", "nombreCampo":"ID", "tipo":orm.XPDINTEGER, "pk":True, "incremental":True, },
        { "nombre":"rolename", "nombreCampo":"ROLENAME", "tipo":orm.XPDSTRING, "tamano":32, },
        { "nombre":"descripcion", "nombreCampo":"DESCRIPCION", "tipo":orm.XPDSTRING, "tamano":128, },
        { "nombre":"activo", "nombreCampo":"ACTIVO", "tipo":orm.XPDINTEGER, },
        ],
    "namedQueries":[
        { "nombre":"findall", "whereClause":["activo",] , "orderBy":["username",] },
        { "nombre":"findByRolename", "whereClause":["rolename",] },
        ]
    })
...
UsuarioRoles.setMetamodelo({
    ...
    "propiedades":[
        ...
        { "nombre":"id_rol", "nombreCampo":"ID_ROL", "tipo":orm.XPDINTEGER, },
        { "nombre":"activo", "nombreCampo":"ACTIVO", "tipo":orm.XPDINTEGER, },
        ],
    "namedQueries":[
        { "nombre":"findByUser", "whereClause":["id_usuario","activo"] , "orderBy":["id_rol",] },
        { "nombre":"findByRol", "whereClause":["id_rol","activo"] , "orderBy":["id_usuario",] },
        {
...
SolicitudesCambioClave.setMetamodelo({
    ...
    "propiedades":[
        { "nombre":"id", "nombreCampo":"ID", "tipo":orm.XPDSTRING, "tamano":36, "pk":True, },
        { "nombre":"id_usuario", "nombreCampo":"ID_USUARIO", "tipo":orm.XPDINTEGER, },
        ],
    "namedQueries":[
        { "nombre":"findById", "whereClause":["id"] , },
...
def getUserByToken(sessiontoken):
    ...
    if len(usuarios) == 0:
        con.close()
        return None
    incluir_roles_usuario(con, usuarios[0])
    con.close()
    return usuarios[0]
...
def registrar_rol(con, rol):
    # valida que el usuario no haya otros usuarios con el mismo username y el mismo email
    roles_repetidos = Roles.getNamedQuery(con, 'findByRolename', { 'rolename' : rol['rolename'] } )
    if len(roles_repetidos) > 0 :
        raise Exception("Rol {0} ya existe".format(rol['rolename']))
    # forma el nuevo objeto usuario
    rol_persistir = {'rolename': rol['rolename'], 'descripcion': rol['descripcion'], 'activo': 1 }
    print(repr(rol_persistir))
    Roles.insertar(con, rol_persistir)
    rol['id'] = rol_persistir['id'] 
    return rol

def incluir_roles_usuario(con:orm.Conexion, usuario):
    sql = """
select a.ROLENAME rolename
from ROLES a
where a.ACTIVO = 1 
and exists( select 1 from USUARIOS_ROLES b where b.ID_USUARIO = :id_usuario and b.ID_ROL = a.ID and b.ACTIVO = 1 )
"""
    lista = con.consultar(sql, { 'id_usuario':usuario['id'] }, ['rolename'])
    usuario['roles'] = [x['rolename'] for x in lista]
