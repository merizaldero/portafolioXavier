...
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (1, 'torso',     2,10, NULL,    '0', '1',  0,  1, 1,   0,  1, 1, 1.00, 1.01, 1, '0');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (2, 'pantalon',  1,11,    1,    '0', '1',  0,  1, 1,   0,  1, 1, 1.00, 1.01, 1, '0');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (3, 'cara',      3, 1,    1,    '0', '0',  0,  1, 1,   0,  1, 1, 0.50, 2.00, 5, '0');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (4, 'pelo',     10, 2,    3,    '0', '1',  0,  1, 1,   0,  1, 1, 1.00, 1.01, 1, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (5, 'ojo',       4, 3,    3,    '1', '0', 10, 40, 5, -20, 20, 5, 0.50, 2.00, 5, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (6, 'ceja',      6, 4,    5,    '1', '1', -5,  5, 5, -20,  0, 5, 0.50, 2.00, 5, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (7, 'oreja',     2, 4,    3,    '1', '1', 80, 80, 1, -20, 20, 5, 0.50, 2.00, 5, '0');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (8, 'nariz',     5, 5,    3,    '0', '0',  0,  0, 1,  15, 30, 5, 0.50, 2.00, 5, '0');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values (9, 'boca',      4, 6,    3,    '0', '0',  0,  0, 1,  20, 40, 5, 0.50, 2.00, 5, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values(10, 'bigote',    8, 7,    9,    '0', '1',  0,  0, 1, -20,  0, 5, 0.50, 2.00, 5, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values(11, 'barba',     7, 8,    9,    '0', '1',  0,  0, 1,   0, 10, 5, 0.50, 2.00, 5, '1');
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, SIMETRICO_X, OPCIONAL, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, TIENE_COLOR ) values(12, 'lente',     9, 9,    8,    '0', '1',  0,  0, 1, -20,  0, 5, 1.00, 1.01, 1, '1');
