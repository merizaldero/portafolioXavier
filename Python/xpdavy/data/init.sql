...
insert into PARTE (ID, NOMBRE, ORDEN_Z, ORDEN_GUI, ID_PARENT, OFFSET_X_MIN, OFFSET_X_MAX, OFFSET_X_STEPS, OFFSET_Y_MIN, OFFSET_Y_MAX, OFFSET_Y_STEPS, SCALE_MIN, SCALE_MAX, SCALE_STEPS, SIMETRICO_X, OPCIONAL, TIENE_COLOR) values (12, 'lente', 9, 9, 3, 0, 0, 1, 0, 0, 1, 3.0, 3.0, 1, '0', '1', '1');
