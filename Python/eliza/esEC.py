...
gPats = [ 
    ...
    "Quizás, eventuslmente, yo voy a %1.",
    "Realmente quieres que yo %1?"]
    ,[["Esperas que yo %1"],[r'Sabes que espero de ti']]
    ],
    
    [r'Mi nombre es (.*)', 
    [ "Tu nombre es %1.", 
    "Te llamas %1.",]
    ,[["Tu nombre es %1.",[r'Cual es mi nombre?']]]
    ],
    ...
    ,[["Piensas que puedes %1",[]]]
    ], 
    
    [r'Tu Eres (.*)', 
    [ "Por qué piensas que Yo soy %1?",
    "Te incomoda pensar que yo sea %1?", 
    "Tal ves te gustaría que yo sea %1.", 
    "Yal vez estás pensando realmente acerca de tí"]
    ,[["Piensas que soy %1",[]]]
    ], 
    ...
    "Estamos hablando acerca de tí o de mí?"]
    ,[["Piensas que soy %1",[]]]
    ], 
    ...
    "Las buenas relaciones con la familia son importantes."]
    ,[["%1 mama %2",[]]]
    ], 
