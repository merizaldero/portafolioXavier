...
mobs:register_mob("xpd_npc:simio", {
	type = "npc",
	passive = false,
	damage = 5,
	...
	textures = {
		{"character_Chimpance-Simio.png"}, -- skin by xpiderman
		{"character_Gorila-Simio.png"},
		{"character_Orangutan-Simio.png"},
	},
...
-- register spawn egg
mobs:register_egg("xpd_npc:simio", "Simio", "mobs_meat_raw.png", 1)

-- this is only required for servers that used the old mobs mod
mobs:alias_mob("xpd_npc:simio", "mobs_npc:simio")
